...
# Download Magento
RUN wget --no-check-certificate -O /root/magento-1.7.0.2.tar.gz https://github.com/snowild/docker-nginx-php5/blob/develop/magento/magento-1.7.0.2.tar.gz?raw=true && wget --no-check-certificate -O /root/magento-app.tar.gz https://github.com/snowild/docker-nginx-php5/blob/develop/magento/sportshop/magento-app.tar.gz?raw=true && wget --no-check-certificate -O /root/magento-skin.tar.gz https://github.com/snowild/docker-nginx-php5/blob/develop/magento/sportshop/magento-skin.tar.gz?raw=true
RUN cd /var/www && tar -xzvf /root/magento-1.7.0.2.tar.gz && cd /var/www/magento && tar -xzvf /root/magento-app.tar.gz && tar -xzvf /root/magento-skin.tar.gz && chmod -R 777 /var/www/magento
